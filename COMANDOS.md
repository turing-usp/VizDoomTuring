...
```powershell
python .\run_train.py --cfg .\stern_deathmatch.yaml --actors-per-match 10 --render host --shm-obs --trainer-port 7200 --port 5200 --progress-bar --frame-skip 4 --ticrate 70 --host-start-delay 1.5 --actor-start-delay 0.02 --match "multi_duel_dm15_smart.wad|map01|5" --match "freedm.wad|MAP02|1" --match "freedm.wad|MAP11|1" --match "freedm.wad|MAP16|1" --match "freedm.wad|MAP27|1" --match "freedm.wad|MAP28|1" --match "freedm.wad|MAP29|1"
```
...
```powershell
python .\run_train.py --cfg .\stern_deathmatch.yaml --num-matches 2 --actors-per-match 12 --render host --shm-obs --trainer-port 7200 --port 5200 --scenario multi_duel_dm15_smart.wad --map map01 --frame-skip 1 --ticrate 35 --host-start-delay 1.5 --actor-start-delay 0.02
```

## Assistir modelo

```powershell
python .\run_train.py --cfg .\stern_deathmatch.yaml --actors-per-match 10 --render all --shm-obs --trainer-port 7200 --port 5200 --progress-bar --frame-skip 1 --ticrate 35 --host-start-delay 1.5 --actor-start-delay 0.02 --match "freedm.wad|MAP11|1" --play
```
